...
/**
 * Created by giannis on 13/6/2016.
 */
public class SoftKeyboardStateWatcher implements ViewTreeObserver.OnGlobalLayoutListener {
    private static final String debugTag = SoftKeyboardStateWatcher.class.getSimpleName();
    ...
    public void onGlobalLayout() {
        ...
        //Log.e(debugTag, "root view height: "+activityRootView.getRootView().getHeight()+" bottom: "+r.bottom+" top: "+r.top);

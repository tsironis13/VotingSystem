package com.votingsystem.tsiro.spinnerLoading;
...
import com.votingsystem.tsiro.animation.CallbackAnimation;
import com.votingsystem.tsiro.interfaces.TransformationListener;
import com.votingsystem.tsiro.utils.SpinnerLoadingUtils;
...
public class SpinnerLoading extends View implements TransformationListener{
    ...
    private float pi2;
    private static final String debugTag = SpinnerLoading.class.getSimpleName();
    ...
    protected void onVisibilityChanged(@NonNull View changedView, int visibility) {
        ...
        if (changedView instanceof SpinnerLoading) {
